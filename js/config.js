...
export var TURNSTILE_SITE_KEY = location.hostname === 'localhost' || location.hostname === '127.0.0.1' ? '' : '0x4AAAAAAC9X9WOjivjdJMJl';
...
<div class="changelog-entry">
  ...
  <div class="changelog-codename">Stardust（星尘）</div>
  <div class="changelog-section">
    <div class="changelog-section-title">
    ...
    <ul class="changelog-list">
      <li><strong>星尘（Stardust）系统</strong>：AI 功能积分制，登录用户每周获得 200 星尘，每周一 00:00 自动刷新（不叠加）</li>
      <li><strong>星尘消耗分级</strong>：AI 评论 ✨2 / AI 回嘴 ✨1 / AI 预测 ✨5 / 薄弱项分析 ✨6 / 突突er ✨1</li>
      <li><strong>星尘 UI</strong>：导航栏余额胶囊（低余额黄色警告）+ 个人名片星尘列 + 各功能标题旁消耗胶囊 + 余额不足弹窗</li>
      <li><strong>星尘使用文档</strong>：站内指南 AI 交互部分新增星尘规则说明与消耗表格</li>
  ...
  <div class="changelog-section">
    ...
    <ul class="changelog-list">
      <li>星尘 AI 成功后扣除（AI 失败不扣星尘，用户零损失）</li>
      <li>本地开发 Turnstile 自动跳过（localhost 免人机验证）</li>
      <li>CORS 暴露自定义 header（前端实时更新星尘余额）</li>
      <li>飞书绑定码移动端适配 — 缩小字体和间距，窄屏不再溢出</li>
      <li>清理 console.warn 调试语句 — dashboard/auth/report 共 8 处</li>
      <li>站内使用文档更新 — 飞书命令表补充至 9 个命令 + 星尘规则</li>
    </ul>
  </div>
  <div class="changelog-section">
    <div class="changelog-section-title">
    ...
    <ul class="changelog-list">
      <li>云同步覆盖星尘数据 — pushToCloud 保留服务端 stardust 字段</li>
      <li>突突er 发送按钮变"发送"文字 — 恢复为 ↑ 箭头</li>
...
export const GUIDE_SECTIONS = [
  { id: 'guide-quick', label: '快速上手', content: `
    <div class="guide-section" id="guide-quick">
      ...
      <div class="guide-quick">
        ...
        <div class="guide-quick-item"><span class="guide-num">7</span>点击右上角头像 → 查看个人名片（等级/经验/打卡/星尘/成就一览）</div>
        <div class="guide-quick-item"><span class="guide-num">8</span>登录后使用 AI 功能消耗星尘，每周一自动恢复 200 星尘</div>
      </div>
    </div>`
  },
  ...
  { id: 'guide-ai', label: 'AI 交互', content: `
    <div class="guide-section" id="guide-ai">
      <div class="guide-section-title">
        <span class="guide-icon" style="background:linear-gradient(135deg,#8b5cf6,#a78bfa);">尘</span>
        星尘（Stardust）
      </div>
      <p class="guide-desc">星尘是 MyScore 中使用 AI 功能的<strong>高级货币</strong>。每个 AI 功能都会消耗一定数量的星尘。</p>
      <table class="guide-table">
        <thead><tr><th>功能</th><th>消耗</th><th>说明</th></tr></thead>
        <tbody>
          <tr><td>AI 评论</td><td class="xp-val">✨ 2</td><td>生成个性化成绩点评</td></tr>
          <tr><td>AI 回嘴</td><td class="xp-val">✨ 1</td><td>与 AI 展开辩论</td></tr>
          <tr><td>AI 预测</td><td class="xp-val">✨ 5</td><td>基于历史数据的成绩趋势预测</td></tr>
          <tr><td>薄弱项分析</td><td class="xp-val">✨ 6</td><td>识别弱科并给出针对性建议</td></tr>
          <tr><td>突突er</td><td class="xp-val">✨ 1</td><td>伴学助手，每条消息消耗</td></tr>
        </tbody>
      </table>
      <p class="guide-desc" style="margin-top:0.75rem;font-size:0.82rem;color:var(--text-muted);">
        <strong>获取规则：</strong>登录用户每周一 00:00 自动获得 200 星尘，刷新时余额清零重置为 200（不叠加）。未登录用户每天可免费使用 8 次 AI 功能（不消耗星尘）。星尘不足时无法使用 AI 功能，需等待周一自动刷新。
      </p>
      <p class="guide-desc" style="margin-top:0.5rem;font-size:0.82rem;color:var(--text-muted);">
        导航栏中 <span style="color:#7c3aed;">✨ 数字</span> 显示当前星尘余额，余额不足 20 时变为黄色警告。
      </p>
    </div>
    <div class="guide-section">
      <div class="guide-section-title">
  ...
  { id: 'guide-growth', label: '成长体系', content: `
    ...
    <div class="guide-section">
      ...
      <ul class="guide-list">
        ...
        <li><strong>数据概览</strong>：总记录 / 星尘 / 连续打卡天数 / 已解锁成就 四列数据</li>
