...
export const GUIDE_SECTIONS = [
  ...
  { id: 'guide-growth', label: '成长体系', content: `
    ...
    <div class="guide-section">
      ...
      <p class="guide-desc">通过使用各项功能积累经验值，提升等级。</p>
  ...
  { id: 'guide-data', label: '数据与安全', content: `
    ...
    <div class="guide-section">
      ...
      <ul class="guide-list">
        <li><strong>导出</strong>：在自定义考试页点击「导出数据」下载 JSON 备份文件</li>
...
export const BETA_BANNER = {
    enabled: true,
    items: [
        'V5.1.0-beta 更新：设置页面重构、快捷工具箱、日志导出、事件埋点',
        '设置二级导航、工具箱收纳、固定尺寸弹窗',
        '快捷工具箱收纳设置/伴学助手/版本日志，桌面端 hover 展开',
